...
forge script script/upgrade_to_CoreV2_3.s.sol:upgrade_to_CoreV2_3_zksync --zksync --rpc-url $RPC_URL --broadcast --verifier zksync --verifier-url https://zksync2-mainnet-explorer.zksync.io/contract_verification --verify -vvvvv --sig "run(string memory chain)" -- "ZKSYNC"
rm .env