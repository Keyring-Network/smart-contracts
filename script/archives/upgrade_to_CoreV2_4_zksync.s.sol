...
import {CoreV2_4_zksync} from "../src/CoreV2_4_zksync.sol";
...
contract upgrade_to_CoreV2_4_zksync is Script, Tooling {
    function run(string memory chain) external {
        ...
        bytes memory initdata = abi.encodeWithSelector(CoreV2_4_zksync.initialize.selector, "");
