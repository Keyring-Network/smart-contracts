...
import {CoreV2_4} from "../src/CoreV2_4.sol";
...
contract upgrade_to_CoreV2_4 is Script, Tooling {
    function run(string memory chain) external {
        ...
        bytes memory initdata = abi.encodeWithSelector(CoreV2_4.initialize.selector, "");
